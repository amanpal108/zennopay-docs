...
<CardGroup cols={2}>
  <Card title="Thailand" icon="flag" href="/concepts/corridors">
    PromptPay QR via GLN International. THB settlement.
  </Card>
  <Card title="Vietnam" icon="flag" href="/concepts/corridors">
    VietQR via 9pay. VND settlement.
  </Card>
</CardGroup>
...
6. Zennopay debits the partner's pre-funded USD float, instructs the local
   payout provider (GLN for TH, 9pay for VN), and the merchant receives
   local currency.
